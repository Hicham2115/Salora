        ...
        <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-3">
          {plans.map((plan) => (
            ...
            >
              ...
              {/* Plan name */}
              <p
                className={`mb-4 text-xs font-semibold tracking-widest uppercase ${plan.dark ? "text-white/50" : "text-[#6b6b6b]"}`}
              >
                {plan.name}
              </p>
              ...
              <div className="mb-2 flex items-end gap-1">
                <span
                  className={`text-sm font-semibold ${plan.dark ? "text-white/60" : "text-[#6b6b6b]"}`}
                >
                  MAD
                </span>
                ...
                <span
                  className={`mb-1.5 text-sm ${plan.dark ? "text-white/60" : "text-[#6b6b6b]"}`}
                >
                  /mo
                </span>
              </div>
              ...
              <p
                className={`mb-8 text-sm leading-relaxed ${plan.dark ? "text-white/60" : "text-[#6b6b6b]"}`}
              >
                {plan.description}
              </p>
              ...
              <ul className="mb-10 flex flex-col gap-3">
                {plan.features.map((f) => (
                  <li key={f} className="flex items-start gap-3 text-sm">
                    ...
                    <span
                      className={plan.dark ? "text-white/80" : "text-[#444]"}
                    >
                      {f}
                    </span>
                  </li>
